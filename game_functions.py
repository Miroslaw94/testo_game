...
def check_events(ai_settings, screen, stats, sb, play_button, highscores_button, ship, aliens, bullets):
...
def check_highscores_button(screen, stats, highscores_button, mouse_x, mouse_y):
    hs_button_clicked = highscores_button.rect.collidepoint(mouse_x, mouse_y)
